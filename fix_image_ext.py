...
if date in state.get('articles', {}):
    ...
    if ct_article:
        ct_article['thumb_image'] = 'https://picsum.photos/1200/630.jpg'
    ...
    if openai_article:
        openai_article['thumb_image'] = 'https://picsum.photos/1200/630.jpg'

with open('state.json', 'w') as f:
    json.dump(state, f, indent=2)

print("Updated image URLs to picsum with .jpg extension")
