...
if date in state.get('articles', {}):
    ...
    if ct_article:
        ct_article['thumb_image'] = 'file:///root/ai-news-daily/cache/dummy.jpg'
    ...
    if openai_article:
        openai_article['thumb_image'] = 'file:///root/ai-news-daily/cache/dummy.jpg'

with open('state.json', 'w') as f:
    json.dump(state, f, indent=2)

print("Updated image URLs to point to local dummy image")
